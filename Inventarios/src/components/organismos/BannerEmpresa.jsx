...
import { useAreasStore } from "../../store/EmpresaStore";
export function BannerArea() {
  const { idarea, mostrarAreas, dataarea, contadorusuarios } = useAreasStore();
  return (
    <Container>
      <div className="content-wrapper-context">
        ...
        <ContentCards>
          <CardDatosEmpresa titulo="Moneda" valor={dataarea?.simbolo} />
